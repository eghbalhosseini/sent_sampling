...
name='group=set_2-dataset=ud_sentences_filter_sample-network_act-bench=None-ave=False'
#name='group=set_2-dataset=ud_sentences_filter_sample-brain_resp-bench=Pereira2018-encoding-weights-ave=False'
