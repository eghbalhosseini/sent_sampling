...
/om/weka/evlab/ehoseini/miniconda3/envs/neural_nlp_2022/bin/python /om2/user/ehoseini/sent_sampling/shape_metric/compute_procrustes_for_vit_models_platonic_Jul2025.py ${vision_list[$SLURM_ARRAY_TASK_ID]} ${layer_list[$SLURM_ARRAY_TASK_ID]}
