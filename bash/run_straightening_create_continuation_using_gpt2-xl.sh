...
/om/user/ehoseini/miniconda3/envs/neural_nlp_2022/bin/python /om/user/ehoseini/sent_sampling/straightening/straightening_create_continuation_using_gpt2-xl.py ${contination_list[$SLURM_ARRAY_TASK_ID]} ${context_list[$SLURM_ARRAY_TASK_ID]}
