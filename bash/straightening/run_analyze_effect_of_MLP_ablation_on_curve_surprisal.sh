...
/om/user/ehoseini/miniconda3/envs/neural_nlp_2022/bin/python /om2/user/ehoseini/sent_sampling/straightening/analyze_the_effect_of_MLP_ablation_on_curvature_and_surprisal_gpt2-xl.py --modelname ${model_list[$SLURM_ARRAY_TASK_ID]} --layer_to_ablate ${layer_to_ablate_list[$SLURM_ARRAY_TASK_ID]}