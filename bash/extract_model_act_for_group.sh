...
echo $(which python)
/om/weka/evlab/ehoseini/miniconda3/envs/neural_nlp_2022/bin/python /om2/user/ehoseini/sent_sampling/sampling/extract_model_activations_parallel.py "${run_model}" "${run_dataset}" "${run_stim_type}" "${splits}" "${run_group_id}"
