...
if __name__ == '__main__':
    ...
    optimizer_id_max = f"coordinate_ascent_eh-obj=D_s_kl_div-n_iter=50-n_samples=225-n_init=1-low_dim=False-pca_var=0.9-pca_type=pytorch-run_gpu=True"
    ...
    # load optim_max
    optimizer_id_min = f"coordinate_ascent_eh-obj=2-D_s_kl_div-n_iter=50-n_samples=225-n_init=1-low_dim=False-pca_var=0.9-pca_type=pytorch-run_gpu=True"
