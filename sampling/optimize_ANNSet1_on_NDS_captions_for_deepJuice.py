...
if __name__ == '__main__':
    ...
    # find NSD_benchmark_captions_clean_v3 in list of list(extract_pool.keys())
    ...
    optimizer_id = f"coordinate_ascent_eh-obj=2-D_s-n_iter=50-n_samples=80-n_init=1-low_dim=False-pca_var=0.9-pca_type=pytorch-run_gpu=True"
    ...
    optim_file = os.path.join(RESULTS_DIR,
                              f"results_{ext_id}_{opt_id}.pkl")
