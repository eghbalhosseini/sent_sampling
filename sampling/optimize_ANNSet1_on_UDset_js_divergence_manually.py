...
if __name__ == '__main__':
    ...
    optimizer_id = "coordinate_ascent_eh-obj=2-D_s_jsd-n_iter=50-n_samples=225-n_init=1-low_dim=False-pca_var=0.9-pca_type=pytorch-run_gpu=True"
    jsd_muliplier = 10.0
    jsd_threshold = 0.2
    ...
    optim_file = os.path.join(RESULTS_DIR,
                              f"results_{ext_id}_{opt_id}_jsd_thr_{optimizer_obj.jsd_threshold}_mult_{jsd_muliplier}_bins_{optimizer_obj.bins}_norm.pkl")
