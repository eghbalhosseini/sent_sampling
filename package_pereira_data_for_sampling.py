...
if __name__ == '__main__':
        ...
        for model_id in model_id_list:
             ...
             len(sent_set)
             sent_topic=[re.findall(f'243sentences.\w+', x)[0].replace('243sentences.','') for x in sent_set]
             ...
             for idx,grp in tqdm(enumerate(a_concat.groupby('layer'))):
                 ...
                 with open(os.path.join('/om/user/ehoseini/MyData/sent_sampling/',f'{expr.lower()}_{model_id}_layer_{idx}_activation_ave_False.pkl'),'wb') as f:
