...
if __name__ == '__main__':
    ...
    fig.show()
    fig.savefig(os.path.join(ANALYZE_DIR, f'curvature_{modelname}_{dataset}_Attn_ablated_vs_change_in_model_surprisal.pdf'), transparent=True)
    fig.savefig(os.path.join(ANALYZE_DIR, f'curvature_{modelname}_{dataset}_Attn_ablated_vs_change_in_model_surprisal.png'), transparent=True)
