...
if __name__ == '__main__':
    ...
    fig.savefig(os.path.join(ANALYZE_DIR, f'curvature_{modelname}_{dataset}_Attn_ablated_query.pdf'), transparent=True)
    fig.savefig(os.path.join(ANALYZE_DIR, f'curvature_{modelname}_{dataset}_Attn_ablated_query.png'), transparent=True)
