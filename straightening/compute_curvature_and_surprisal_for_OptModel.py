...
if __name__ == '__main__':
    ...
    modelclass = 'gpt2'
    modelname= 'gpt2'
    newmodelname="facebook/opt-1.3b"
    masked = False
    ...
    new_model_untrained_config = OPTConfig.from_pretrained(newmodelname)
    new_model_untrained = OPTModel(new_model_untrained_config)
