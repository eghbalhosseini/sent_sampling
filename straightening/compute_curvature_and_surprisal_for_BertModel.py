...
if __name__ == '__main__':
    ...
    modelclass = 'gpt2'
    modelname= 'gpt2'
    newmodelname="bert-large-uncased"
    masked = False
    ...
    new_model_untrained_config=AutoConfig.from_pretrained(newmodelname)
    new_model_untrained=BertModel(new_model_untrained_config)
