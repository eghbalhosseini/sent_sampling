...
if __name__ == '__main__':
    ...
    optim_id = ['coordinate_ascent_eh-obj=D_s-n_iter=500-n_samples=125-n_init=1-low_dim=False-pca_var=0.9-pca_type=sklearn-run_gpu=True'
        ,'coordinate_ascent_eh-obj=2-D_s-n_iter=500-n_samples=125-n_init=1-low_dim=False-pca_var=0.9-pca_type=sklearn-run_gpu=True']
    #
    ...
    Ds_rand_file_selected='sent,G=best_performing_pereira_1-D=ud_sentencez_token_filter_v3_minus_ev_sentences_len_7_14_textNoPeriod-activation-B=None-AVE=False,coordinate_ascent_eh-O=D_rand-Nit=500-Ns=125-Nin=1-LD=False-V=0.9-T=sklearn-GPU=True_eh_edit.csv'
    Ds_min_file_selected='sent,G=best_performing_pereira_1-D=ud_sentencez_token_filter_v3_minus_ev_sentences_len_7_14_textNoPeriod-activation-B=None-AVE=False,coordinate_ascent_eh-O=2-D_s-Nit=500-Ns=125-Nin=1-LD=False-V=0.9-T=sklearn-GPU=True_eh_edit.csv'
    Ds_max_file_selected='sent,G=best_performing_pereira_1-D=ud_sentencez_token_filter_v3_minus_ev_sentences_len_7_14_textNoPeriod-activation-B=None-AVE=False,coordinate_ascent_eh-O=D_s-Nit=500-Ns=125-Nin=1-LD=False-V=0.9-T=sklearn-GPU=True_eh_select.csv'
    Ds_rand_file_selected=Path(RESULTS_DIR,Ds_rand_file_selected)
    Ds_max_file_selected=Path(RESULTS_DIR,Ds_max_file_selected)
    Ds_min_file_selected=Path(RESULTS_DIR,Ds_min_file_selected)
